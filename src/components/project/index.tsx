    ...
    return (
        <div style={{display: "flex", alignItems: "center", justifyContent: "center", padding: "2rem"}}>
            ...
            <div style={{maxWidth: "800px"}}>
                <Project showMore goHomeBtn goBackBtn={goBack} imageUrl={project.imageUrl} videoUrl={project.videoUrl}
                         title={project.title} type={project.type} date={project.date} content={project.content}
                         tags={project.tags} showMoreHeight={project.showMoreHeight} id={project.id}/>
            </div>
            }
        </div>
    );
