...
const AboutSection = (props: AboutSectionProps) => {
  return (
    <div className="card" style={{ width: "100%" }}>
      <div style={{ display: "flex", flexDirection: props.isMobileCss ? "column" : "row", paddingTop: 64, paddingBottom: 64, paddingRight: 48, paddingLeft: 48 }}>
        <div style={{ display: "flex", flexDirection: "column", flex: 0.5, borderBottomStyle: props.isMobileCss ? "solid" : "none", borderBottomWidth: 1, marginBottom: props.isMobileCss ? 10 : 0 }}>
          <Image src={deepak_picture} fluid rounded style={{ width: props.isMobileCss ? "100%" : "60%", height: "auto" }} />
